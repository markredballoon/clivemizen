...
<div class="full-height panel panel-sm">
	<div class="bg" style="background-color:#555"></div>
	<div class="container">
		<div class="row">
...
<div class="full-height panel panel-md">
	<div class="bg" style="background-color:#777"></div>
	<div class="container">
		<div class="row">
			<div class="col-xs-24 text-center">
				<h4>Medium Panel</h4>
...
<div class="full-height panel panel-lg">
	<div class="bg" style="background-color:#999"></div>
	<div class="container">
		<div class="row">
			<div class="col-xs-24 text-center">
				<h4>Large Panel</h4>
