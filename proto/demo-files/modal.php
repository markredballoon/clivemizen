...
<button type="button" class="btn btn-lg" data-toggle="modal" data-target="#example-modal">Open Modal</button>
<p>
  This is a stripped down bootstrap modal. The core styles are in proto/bootstrap/less/modal.less. It doesn't require any other JS.
</p>

</div><!--main-->

<div id="example-modal" class="modal fade" role="dialog">
