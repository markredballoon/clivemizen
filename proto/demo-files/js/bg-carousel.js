...
*/
var $window             = $(window);
    $bgWrap             = $('.bg-carousel-wrap'),
    $staticDiv          = $('.bg-carousel-wrap .bg-carousel-static'),
    $animateDiv         = $('.bg-carousel-wrap .bg-carousel-animate'),
    $controls           = $('.bg-carousel-control .move-background'),
    noBackgrounds       = backgroundImages.length - 1,
    curBackground       = 0,
    bgArray             = backgroundImages ;
