...
function add_video_base_files(){
    if ( shortcode_exists('video') ) {
        wp_enqueue_script( 'video-script', plugins_url( 'js/video-base.js', __FILE__ ), array('jquery'),'1.0', true);
        wp_enqueue_style( 'video-styles',  plugins_url( 'css/video-base.min.css', __FILE__ ));
    };
}
